...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "elnode" '("ELNODE-FORM-DATA-TYPE" "elnode" "http-referrer" "if-elnode-auth" "with-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "elnode-bm" '("elnode-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "elnode-compat" '("elnode-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "elnode-js" '("elnode-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "elnode-tests" '("elnode-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "elnode-testsupport" '("assert-elnode-response" "elnode-" "should-" "with-elnode-mock-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "elnode-tools" '("elnode-" "process-sentinel-set")))
